...
<template>
  <div class="nav-content">
    <el-aside width="200px">
      <el-menu :default-openeds="['1']" unique-opened @select="selMenu">
        <el-submenu
        ...
        >
          ...
          <el-menu-item-group>
            <el-menu-item
              v-for="(item2, index2) in item1.childrenMenu"
              :key="index2"
  ...
  data() {
    return {
      menuList: [
        ...
        {
          menuName: '权限管理',
          childrenMenu: [{ menuName: '管理员列表' }],
        },
        {
          menuName: '站点管理',
          childrenMenu: [{ menuName: '友链列表' }, { menuName: '访问记录' }],
        },
      ],
    }
  },
    ...
    selMenu(index) {
      switch (index) {
        ...
        case '2-1':
          ...
          break
        case '3-1':
          this.$route.name !== 'friendManage' &&
            this.$router.push({ name: 'friendManage' })
          break
        case '3-2':
          this.$route.name !== 'statisticsManage' &&
            this.$router.push({ name: 'statisticsManage' })
          break
      }
    },
  },
