...
export const getAllArticle = (plyload) =>
  _GET(Http + '/api/getAllArticle', plyload)
...
export const recoveryArticle = (plyload) =>
  _PUT(Http + '/api/recoveryArticle', plyload)

export const delArticle = (plyload) =>
  _DELETE(Http + '/api/delArticle', plyload)
