  ...
  <div class="article-manage-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="文章标签" prop="classifyId">
          <el-checkbox-group v-model="formData.classifyId">
            <el-checkbox-button
              v-for="item in tagList"
              :label="`${item._id},${item.classifyName}`"
              :key="item._id"
        ...
        <el-form-item label="文章状态" prop="isDel">
          <el-radio-group v-model="formData.isDel" size="small">
            <el-radio border :label="0">公开</el-radio>
            <el-radio border :label="1">私密</el-radio>
          </el-radio-group>
        </el-form-item>
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs['form'].validate((valid) => {
        if (valid) {
          let articleAction = this.formData._id
